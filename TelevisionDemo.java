...
public class TelevisionDemo
	...
	public static void main(String[] args)
	{
		...
		//take user input and change the channel on the television
		portable.setChannel(keyboard.nextInt());
		
		//lower the volume of the television by 2
		portable.decreaseVolume();
		portable.decreaseVolume();
		
		//display the the new channel and volume of the television
